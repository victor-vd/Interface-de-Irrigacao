const ENDEREÇO = {
    "URLPagina": `http://127.0.0.1:5501/Paginas/PainelPrincipal.html`,
}
...
function enviarComando(comandoCliente) {
    if (comandoCliente != "erro") {
        console.log(comandoCliente);
    } else {
        window.alert("Informações inválidas");
        window.location.href = `${ENDEREÇO.URLPagina}`;
    }
}
